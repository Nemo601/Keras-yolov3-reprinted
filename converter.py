...
if __name__ == "__main__":
    txt_path = 'G:/ship_detect/train/labelTxt-v1.0/label/'
    xml_path = 'G:/ship_detect/train/labelTxt-v1.0/Annotations/'
    img_path = 'G:/ship_detect/train/images/part1/images/'
